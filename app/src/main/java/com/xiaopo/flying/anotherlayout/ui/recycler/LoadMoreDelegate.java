package com.xiaopo.flying.anotherlayout.ui.recycler;
...
public class LoadMoreDelegate {
  ...
  public void attach(RecyclerView recyclerView) {
    ...
    recyclerView.addOnScrollListener(new InfinityScrollListener(layoutManager, loadMoreSubject));
  }

  private static class InfinityScrollListener extends RecyclerView.OnScrollListener {

    private static final int VISIBLE_THRESHOLD = 2;
    private final LinearLayoutManager layoutManager;
    private final LoadMoreSubject loadMoreSubject;

    private InfinityScrollListener(LinearLayoutManager layoutManager,
