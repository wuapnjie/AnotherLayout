package com.xiaopo.flying.puzzzzle.ui.widget;
 ...
 * <p/>
 * Use {@link #setBlurredView(android.view.View)} to set up the reference to the view to be
 * blurred.
...
public class BlurView extends View {
  ...
  public BlurView(Context context, AttributeSet attrs) {
    ...
    setDownsampleFactor(
        a.getInt(R.styleable.PxBlurringView_downsampleFactor, defaultDownsampleFactor));
